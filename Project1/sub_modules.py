...
class Parallel_Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 10, kernel_size=5, padding=0)  # 10x10x10
        self.conv2 = nn.Conv2d(10, 20, kernel_size=5, padding=0) # 20x6x6
        self.conv3 = nn.Conv2d(20, 30, kernel_size=5, padding=0) # 30x2x2 
        self.fc1 = nn.Linear(30*2*2, 50) 
    ...
    def forward(self, x):
        ...
        x = F.relu(self.fc1(x.view(-1, 30*2*2)))
        x = F.relu(self.fc2(x))
        x = self.fc3(x)
        return x 
